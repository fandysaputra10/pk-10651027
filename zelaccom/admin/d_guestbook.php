					...
					<?php
						...
						while($data=mysql_fetch_array($query)){
							...
							echo"<tr align=\"center\">
							  ...
							  <td>$data[message]</td>
							  <td>$data[tanggal]</td>
							  <td><a href='?menu=d_guestbook&delete=$data[id_testimoni]'><img src=\"images/delete.png\" title=\"Hapus ini\"></a></td>
							</tr>";
						}
						if($_GET['delete']){
							$id=$_GET['delete'];
						...
						if($query==1){
								echo"$alert";
								echo "<meta http-equiv='refresh' content='2 URL=?menu=d_guestbook'>";
							}else{
